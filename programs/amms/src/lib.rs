...
pub mod amms {
    ...
    pub fn swap_tokens(ctx: Context<SwapTokens>,_fees_in_basis_points:u16,swap_a:bool,input_amount:u64,min_output_amount:u64) -> Result<()> {
     ...
     pub fn withdraw_liquidity(ctx: Context<WithdrawLiquidity>,_fees_in_basis_points:u16,amount:u64) -> Result<()> {
        instructions::withdraw_liquidity::process_withdraw_liquidity(ctx,_fees_in_basis_points,amount)
    }
}
